...
namespace DScript.Runtime
{
    ...
    /// 13参数回调函数
    /// </summary>
    public class Function_13_SValue : SValue
    {
        public readonly Function_13 Value;

        public Function_13_SValue(Function_13 value)
        {
            Value = value;
            dataType = DataType.Function_13;
        }
        ...
        {
            return key == "length" ? Thirteen : Null;
        }
        ...
        {
            return Value(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12);
        }
        ...
        {
            if (v2.dataType == DataType.Function_13)
            {
                return Value == ((Function_13_SValue)v2).Value;
            }
