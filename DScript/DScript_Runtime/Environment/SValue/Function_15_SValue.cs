...
namespace DScript.Runtime
{
    ...
    /// 15参数回调函数
    /// </summary>
    public class Function_15_SValue : SValue
    {
        public readonly Function_15 Value;

        public Function_15_SValue(Function_15 value)
        {
            Value = value;
            dataType = DataType.Function_15;
        }
        ...
        {
            return key == "length" ? Fifteen : Null;
        }
        ...
        {
            return Value(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14);
        }
        ...
        {
            if (v2.dataType == DataType.Function_15)
            {
                return Value == ((Function_15_SValue)v2).Value;
            }
