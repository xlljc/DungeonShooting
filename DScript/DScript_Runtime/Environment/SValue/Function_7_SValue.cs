...
namespace DScript.Runtime
{
    ...
    /// 7参数回调函数
    /// </summary>
    public class Function_7_SValue : SValue
    {
        public readonly Function_7 Value;

        public Function_7_SValue(Function_7 value)
        {
            Value = value;
            dataType = DataType.Function_7;
        }
        ...
        {
            return Value(v0, v1, v2, v3, v4, v5, v6);
        }
        ...
        {
            if (v2.dataType == DataType.Function_7)
            {
                return Value == ((Function_7_SValue)v2).Value;
            }
