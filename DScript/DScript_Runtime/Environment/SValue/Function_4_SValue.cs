...
namespace DScript.Runtime
{
    ...
    /// 4参数回调函数
    /// </summary>
    public class Function_4_SValue : SValue
    {
        public readonly Function_4 Value;

        public Function_4_SValue(Function_4 value)
        {
            Value = value;
            dataType = DataType.Function_4;
        }
        ...
        {
            if (v2.dataType == DataType.Function_4)
            {
                return Value == ((Function_4_SValue)v2).Value;
            }
