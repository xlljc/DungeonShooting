...
namespace DScript.Runtime
{
    ...
    /// 12参数回调函数
    /// </summary>
    public class Function_12_SValue : SValue
    {
        public readonly Function_12 Value;

        public Function_12_SValue(Function_12 value)
        {
            Value = value;
            dataType = DataType.Function_12;
        }
        ...
        {
            return Value(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11);
        }
        ...
        {
            if (v2.dataType == DataType.Function_12)
            {
                return Value == ((Function_12_SValue)v2).Value;
            }
