...
namespace DScript.Runtime
{
    ...
    /// 11参数回调函数
    /// </summary>
    public class Function_11_SValue : SValue
    {
        public readonly Function_11 Value;

        public Function_11_SValue(Function_11 value)
        {
            Value = value;
            dataType = DataType.Function_11;
        }
        ...
        {
            return Value(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10);
        }
        ...
        {
            if (v2.dataType == DataType.Function_11)
            {
                return Value == ((Function_11_SValue)v2).Value;
            }
