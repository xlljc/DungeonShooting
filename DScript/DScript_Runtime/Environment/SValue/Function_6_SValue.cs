...
namespace DScript.Runtime
{
    ...
    /// 6参数回调函数
    /// </summary>
    public class Function_6_SValue : SValue
    {
        public readonly Function_6 Value;

        public Function_6_SValue(Function_6 value)
        {
            Value = value;
            dataType = DataType.Function_6;
        }
        ...
        {
            return Value(v0, v1, v2, v3, v4, v5);
        }
        ...
        {
            if (v2.dataType == DataType.Function_6)
            {
                return Value == ((Function_6_SValue)v2).Value;
            }
