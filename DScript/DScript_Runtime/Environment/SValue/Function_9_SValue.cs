...
namespace DScript.Runtime
{
    ...
    /// 9参数回调函数
    /// </summary>
    public class Function_9_SValue : SValue
    {
        public readonly Function_9 Value;

        public Function_9_SValue(Function_9 value)
        {
            Value = value;
            dataType = DataType.Function_9;
        }
        ...
        public override SValue Invoke(SValue v0, SValue v1, SValue v2, SValue v3, SValue v4, SValue v5, SValue v6,
            SValue v7, SValue v8)
        {
            return Value(v0, v1, v2, v3, v4, v5, v6, v7, v8);
        }
        ...
        {
            if (v2.dataType == DataType.Function_9)
            {
                return Value == ((Function_9_SValue)v2).Value;
            }
