...
namespace DScript.Runtime
{
    ...
    /// 8参数回调函数
    /// </summary>
    public class Function_8_SValue : SValue
    {
        public readonly Function_8 Value;

        public Function_8_SValue(Function_8 value)
        {
            Value = value;
            dataType = DataType.Function_8;
        }
        ...
        public override SValue Invoke(SValue v0, SValue v1, SValue v2, SValue v3, SValue v4, SValue v5, SValue v6,
            SValue v7)
        {
            return Value(v0, v1, v2, v3, v4, v5, v6, v7);
        }
        ...
        {
            if (v2.dataType == DataType.Function_8)
            {
                return Value == ((Function_8_SValue)v2).Value;
            }
