...
namespace DScript.Runtime
{
    ...
    /// 2参数回调函数
    /// </summary>
    public class Function_2_SValue : SValue
    {
        public readonly Function_2 Value;

        public Function_2_SValue(Function_2 value)
        {
            Value = value;
            dataType = DataType.Function_2;
        }
        ...
        {
            if (v2.dataType == DataType.Function_2)
            {
                return Value == ((Function_2_SValue)v2).Value;
            }
