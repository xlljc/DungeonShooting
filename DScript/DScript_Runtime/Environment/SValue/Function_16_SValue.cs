...
namespace DScript.Runtime
{
    ...
    /// 16参数回调函数
    /// </summary>
    public class Function_16_SValue : SValue
    {
        public readonly Function_16 Value;

        public Function_16_SValue(Function_16 value)
        {
            Value = value;
            dataType = DataType.Function_16;
        }
        ...
        {
            return key == "length" ? Sixteen : Null;
        }
        ...
        {
            return Value(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15);
        }
        ...
        {
            if (v2.dataType == DataType.Function_16)
            {
                return Value == ((Function_16_SValue)v2).Value;
            }
