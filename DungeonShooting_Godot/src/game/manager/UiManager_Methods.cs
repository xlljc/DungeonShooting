...
public static partial class UiManager
{
    ...
    {
        return CreateUi<UI.WeaponRoulette.WeaponRoulettePanel>(UiNames.WeaponRoulette);
    }
    ...
    {
        return OpenUi<UI.WeaponRoulette.WeaponRoulettePanel>(UiNames.WeaponRoulette);
    }
    ...
    {
        return GetUiInstance<UI.WeaponRoulette.WeaponRoulettePanel>(nameof(UI.WeaponRoulette.WeaponRoulette));
    }
