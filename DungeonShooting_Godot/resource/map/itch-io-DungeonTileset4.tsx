...
<tileset version="1.8" tiledversion="1.8.5" name="itch-io-DungeonTileset4" tilewidth="16" tileheight="16" tilecount="192" columns="16">
 ...
 <wangsets>
  ...
  <wangset name="north wall(outside)" type="edge" tile="-1">
   <wangcolor name="" color="#ff0000" tile="-1" probability="1"/>
   <wangtile tileid="17" wangid="0,0,1,0,0,0,0,0"/>
   <wangtile tileid="18" wangid="0,0,1,0,0,0,1,0"/>
   <wangtile tileid="19" wangid="0,0,0,0,0,0,1,0"/>
  </wangset>
  <wangset name="north wall(inner)" type="edge" tile="-1">
   <wangcolor name="" color="#ff0000" tile="-1" probability="1"/>
   <wangtile tileid="117" wangid="0,0,1,0,0,0,0,0"/>
   <wangtile tileid="118" wangid="0,0,1,0,0,0,1,0"/>
   <wangtile tileid="119" wangid="0,0,0,0,0,0,1,0"/>
  </wangset>
  <wangset name="north wall(left)" type="edge" tile="-1">
   <wangcolor name="" color="#ff0000" tile="-1" probability="1"/>
   <wangtile tileid="120" wangid="0,0,1,0,0,0,0,0"/>
   <wangtile tileid="121" wangid="0,0,1,0,0,0,1,0"/>
   <wangtile tileid="122" wangid="0,0,0,0,0,0,1,0"/>
  </wangset>
  <wangset name="north wall(right)" type="edge" tile="-1">
   <wangcolor name="" color="#ff0000" tile="-1" probability="1"/>
   <wangtile tileid="116" wangid="0,0,1,0,0,0,0,0"/>
   <wangtile tileid="117" wangid="0,0,1,0,0,0,1,0"/>
   <wangtile tileid="118" wangid="0,0,0,0,0,0,1,0"/>
  </wangset>
 </wangsets>
</tileset>
